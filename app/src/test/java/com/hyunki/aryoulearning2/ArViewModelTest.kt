...
class ArViewModelTest {
    ...
    @Test
    fun `assert getModelsFromRepositoryByCategory() sets modelLiveData to arStateLoading on call before complete`() = coroutinesTestRule.testDispatcher.runBlockingTest {
