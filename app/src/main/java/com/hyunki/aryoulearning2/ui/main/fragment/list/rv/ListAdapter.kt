package com.hyunki.aryoulearning2.ui.main.fragment.list.rv
...
class ListAdapter(val fListener: FragmentListener) : RecyclerView.Adapter<ListAdapter.CategoryViewHolder>() {
